...
public class ContactController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "400", description = "\"Name cannot be blank, Phone number cannot be blank", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        @ApiResponse(responseCode = "200", description = "Successful retrieval of contact", content = @Content(schema = @Schema(implementation = Contact.class))),
        })
